                ...
                <div className="overflow-y-auto flex flex-col md:flex-row h-full">
                    ...
                    <div className="w-full md:w-5/12 bg-[var(--primary-color-tint-95)] relative h-80 md:h-auto md:min-h-full shrink-0">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-[var(--primary-black)]/90 via-transparent to-transparent md:bg-gradient-to-t md:from-[var(--primary-black)]/80 md:to-transparent flex flex-col justify-end p-5 md:p-10">
                            <h3 className="text-white text-2xl md:text-3xl font-serif font-bold mb-0.5 md:mb-1">Ferasat Ayesha</h3>
                    ...
                    <div className="w-full md:w-7/12 p-6 md:p-12 bg-white overflow-y-auto">
                        ...
                        <div className="space-y-4 md:space-y-6 text-[var(--grey)] leading-relaxed text-sm md:text-lg font-light">
                            <p>
                                With over five years of professional experience in clinical psychology, I am committed to providing compassionate and effective mental health support to adults, couples, and teenagers. As a qualified psychologist, I specialize in anxiety, depression, mood disorders, stress management, and relationship concerns, using a client-centered and evidence-based approach to promote emotional well-being and long-term psychological growth.                    </p>
                            <p>
                                I offer both online and in-person therapy sessions. My practice focuses on creating a safe, confidential, and non-judgmental environment where clients feel understood and supported throughout their mental health journey.                            </p>
